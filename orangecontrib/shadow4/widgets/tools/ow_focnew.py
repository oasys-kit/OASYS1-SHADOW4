...
class FocNew(AutomaticElement):
    ...
    def __init__(self):
        ...
        self.le_y_range_min = oasysgui.lineEdit(self.yrange_box, self, "y_range_min", "Y min [m]", labelWidth=260, valueType=float, orientation="horizontal")
        self.le_y_range_max = oasysgui.lineEdit(self.yrange_box, self, "y_range_max", "Y max [m]", labelWidth=260, valueType=float, orientation="horizontal")
...
if __name__ == "__main__":
    def get_beamline():
        ...
        coordinates = ElementCoordinates(p=2.7, q=0, angle_radial=1.5638, angle_azimuthal=1.5708,
